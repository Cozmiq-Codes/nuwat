                        ...
                        <div className="flex flex-col gap-10 lg:gap-0 lg:justify-between h-full">
                            <div className="flex flex-col gap-6 sm:gap-8">
                                ...
                                <p className="text-white text-sm sm:text-base font-medium leading-6 sm:leading-7">
                                    <span className="heading-span">Koshy Samuel</span> is a sovereign force in
                                    the world of high-stakes enterprise. He does not just manage
                                    businesses; he engineers empires. Having built, scaled, and
                                    ultimately exited one of the most formidable industrial
                                    conglomerates in the region’s history, his career serves as a
                                    masterclass in market dominance. He has spent decades operating
                                    at a level of complexity that few can comprehend and fewer can
                                    survive, delivering mission-critical infrastructure for global
                                    superpowers. His reputation is built on the cold, hard reality
                                    of total execution—a legacy forged in steel, power, and the kind
                                    of strategic foresight that only a true mogul possesses.
                                </p>
                            </div>
                            ...
                            <div className="p-4 sm:p-5 lg:p-6 bg-[#131313] rounded-2xl lg:rounded-[18px]">
                                <p className="text-sm sm:text-base font-medium leading-6 sm:leading-7 heading-span italic">
                                    ...
                                    firm—you are aligning with a genius of industry who has already
                                    proven, beyond all shadow of a doubt, that he is the standard
