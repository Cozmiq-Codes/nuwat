                ...
                <div className={"section-wrapper"}>
                    <div className={"what_we_do_left"}>
                        ...
                        <div className="what_we_do_img">
                            <Image src="/layout/what-we-do/building.png" alt="Building" width={550} height={350} />
                        </div>
                    </div>
                    <div className={"what_we_do_right"}>
                        <h3 className="wwdr_heading">
                            <span className="text-cyan-400">Nuwat is a business
                                transformation</span> firm built for companies that refuse to stay
                            ordinary, outpace their market, and raise the standard{" "}
